...
def topwin():
    ...
    def calculator():
        try:
            ...
            note2000 = amount // 2000 #5000//2000 = 2
            amount %= 2000 #5000%2000 = 1000
            note500 = amount // 500 #1000//500 = 2
            amount%= 500 #1000%500 = 0
            note100 = amount // 100 #0//100 = 0

            t1.delete(0, END)#this deletes everything from index 0(start) to END (last character)
            t2.delete(0, END)
            t3.delete(0, END)
